    ...
    var e = {}, d = e.lib = {}, m = function () {
        ...
        u = d.BufferedBlockAlgorithm = n.extend({
            reset: function () {
                ...
                var b = this._data, d = b.words, f = b.sigBytes, l = this.blockSize, e = f / (4 * l),
...
(function () {
    var g = CryptoJS, j = g.lib, e = j.Base, d = j.WordArray, j = g.algo, m = j.HMAC, n = j.PBKDF2 = e.extend({
        cfg: e.extend({keySize: 4, hasher: j.SHA1, iterations: 1}), init: function (d) {
